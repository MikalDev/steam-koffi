 ...
 */
export var ECallbackType;
(function (ECallbackType) {
    ECallbackType[ECallbackType["SteamServersConnected"] = 101] = "SteamServersConnected";
    ECallbackType[ECallbackType["SteamServerConnectFailure"] = 102] = "SteamServerConnectFailure";
    ECallbackType[ECallbackType["SteamServersDisconnected"] = 103] = "SteamServersDisconnected";
    ECallbackType[ECallbackType["ClientGameServerDeny"] = 113] = "ClientGameServerDeny";
    ECallbackType[ECallbackType["GSPolicyResponse"] = 115] = "GSPolicyResponse";
    ECallbackType[ECallbackType["IPCFailure"] = 117] = "IPCFailure";
    ECallbackType[ECallbackType["LicensesUpdated"] = 125] = "LicensesUpdated";
    ECallbackType[ECallbackType["AppLifetimeNotice"] = 130] = "AppLifetimeNotice";
    ECallbackType[ECallbackType["DRMSDKFileTransferResult"] = 143] = "DRMSDKFileTransferResult";
    ECallbackType[ECallbackType["ValidateAuthTicketResponse"] = 143] = "ValidateAuthTicketResponse";
    ECallbackType[ECallbackType["MicroTxnAuthorizationResponse"] = 152] = "MicroTxnAuthorizationResponse";
    ECallbackType[ECallbackType["EncryptedAppTicketResponse"] = 154] = "EncryptedAppTicketResponse";
    ECallbackType[ECallbackType["GetAuthSessionTicketResponse"] = 163] = "GetAuthSessionTicketResponse";
    ECallbackType[ECallbackType["GameWebCallback"] = 164] = "GameWebCallback";
    ECallbackType[ECallbackType["StoreAuthURLResponse"] = 165] = "StoreAuthURLResponse";
    ECallbackType[ECallbackType["MarketEligibilityResponse"] = 166] = "MarketEligibilityResponse";
    ECallbackType[ECallbackType["DurationControl"] = 167] = "DurationControl";
    ECallbackType[ECallbackType["GetTicketForWebApiResponse"] = 168] = "GetTicketForWebApiResponse";
    ECallbackType[ECallbackType["UserStatsReceived"] = 1101] = "UserStatsReceived";
